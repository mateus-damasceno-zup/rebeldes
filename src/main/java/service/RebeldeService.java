...
public class RebeldeService {
    ...
    public void inseriRebelde(String nome, int idade, String genero, boolean traidor, Long baseId, Inventario inventario){
        ...
        String sql = "INSERT INTO rebeldes (nome_rebelde, idade_rebelde, genero_rebelde, traidor_rebelde, base_id, inventario_id) VALUES ('"+nome+"', '"+idade+"', '"+genero+"', "+traidor+", '"+baseId+"', '"+inventario.getId()+"');";
        try{
